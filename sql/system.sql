...
<id column="newId" jdbcType="BIGINT" property="newid" />
    <result column="newUrl" jdbcType="VARCHAR" property="newurl" />
    ...
    <result column="newOther" jdbcType="VARCHAR" property="newother" />
		
		
--  获取文章表
drop table if exists new_e;
CREATE TABLE `new_e`  (
  `newid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '文章ID',
	`newcontent` text DEFAULT NULL COMMENT '文章内容',
  `newurl` varchar(255) DEFAULT NULL COMMENT '路径',
	`newtitle` varchar(255) DEFAULT NULL COMMENT '标题',
	`newcreatetime` datetime DEFAULT NULL COMMENT '文章创作时间',
	`newsource` varchar(255) DEFAULT NULL COMMENT '文章来源',
	`newauthor` varchar(255) DEFAULT NULL COMMENT '文章作者',
	`collecttime` datetime DEFAULT NULL COMMENT '收集时间',
	`newother` varchar(255) DEFAULT NULL COMMENT '其他',
  PRIMARY KEY (`newid`) USING BTREE
) CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '获取文章表' ROW_FORMAT = Dynamic;

--  分词表
drop table if exists fc_new;
CREATE TABLE `fc_new`  (
  `fc_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '文章ID',
	`fc_newcontent` text DEFAULT NULL COMMENT '分词文章内容',
	`fc_newtitle` varchar(255) DEFAULT NULL COMMENT '标题',
	`fc_newsource` varchar(255) DEFAULT NULL COMMENT '分词文章来源',
	`fc_newauthor` varchar(255) DEFAULT NULL COMMENT '分词文章作者',
	`fc_collecttime` datetime DEFAULT NULL COMMENT '收集时间',
	`fc_newother` varchar(255) DEFAULT NULL COMMENT '其他',
  PRIMARY KEY (`fc_id`) USING BTREE
) CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分词表' ROW_FORMAT = Dynamic;


-- 菜单 SQL
INSERT INTO `sys_power`
VALUES ('1453542364613181440', '获取文章菜单', '1', 'system:newe:main', '/system/newe/main', '_iframe', '${parentMenuId}', 'layui-icon layui-icon-set-fill', 1, NULL, NULL, NULL, NULL, NULL, '1');
...
INSERT INTO `sys_power`
VALUES ('1453542364613181441', '获取文章列表', '2', 'system:newe:data', '', NULL, '1453542364613181440', 'layui-icon layui-icon-set-fill', 1, NULL, NULL, NULL, NULL, NULL, '1');

INSERT INTO `sys_power`
VALUES ('1453542364613181442', '获取文章新增', '2', 'system:newe:add', '', NULL, '1453542364613181440', 'layui-icon layui-icon-set-fill', 1, NULL, NULL, NULL, NULL, NULL, '1');

INSERT INTO `sys_power`
VALUES ('1453542364613181443', '获取文章修改', '2', 'system:newe:edit', '', NULL, '1453542364613181440', 'layui-icon layui-icon-set-fill', 1, NULL, NULL, NULL, NULL, NULL, '1');

INSERT INTO `sys_power`
VALUES ('1453542364613181444', '获取文章删除', '2', 'system:newe:remove', '', NULL, '1453542364613181440', 'layui-icon layui-icon-set-fill', 1, NULL, NULL, NULL, NULL, NULL, '1');
